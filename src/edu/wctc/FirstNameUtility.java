...
public class FirstNameUtility {
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException{
        //If the first name is blank, throws a MissingNameException.
        ...
        int middleInitialValue =0;
            ...
            if (!firstName.isEmpty()){
                    ...
                    {
                         firstNameValue = firstNameCodeMap.get(firstName);

                    }
                    else{
                        String x = String.valueOf(firstName.toUpperCase().charAt(0));
                        firstNameValue = firstInitialCodeMap.get(x);

                    }
                if (middleInitial != null){
                    middleInitialValue = middleInitialCodeMap.get(middleInitial.toUpperCase());
                }
                else{}
        ...
        // If the first name appears in the first name map, returns the sum of the codes for the first name and middle initial.

        // If not, it returns the sum of the codes for the first initial and middle initial.
